...
export default function BackfillRemoteForm({ employees }: { employees: Employee[] }) {
  ...
  async function submit(e: React.FormEvent) {
    ...
    const res = await fetch('/api/admin/backfill-remote', {
      method: 'POST',
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 p-6">
            <div className="flex items-center justify-between mb-5">
              <h2 className="text-lg font-bold text-slate-800">Add Historical Remote Work</h2>
            ...
            <p className="text-xs text-slate-500 mb-5 bg-amber-50 border border-amber-100 rounded-lg px-3 py-2">
              This will be recorded as already-approved and will appear in the employee&apos;s remote work history.
            </p>
            ...
            <form onSubmit={submit} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. Pre-system approval"
                  className="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-slate-300"
                />
              </div>
