      ...
      {pto && (
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          <div className="bg-white rounded-xl p-5 shadow-sm border border-slate-100">
            ...
            <p className="text-3xl font-bold text-green-600">{pto.currentBalance.toFixed(2)}</p>
            <p className="text-xs text-slate-400 mt-1">hours available</p>
          </div>
          <div className="bg-white rounded-xl p-5 shadow-sm border border-slate-100">
            ...
            <p className="text-xs text-slate-400 mt-1">hours carried over</p>
          </div>
          <div className="bg-white rounded-xl p-5 shadow-sm border border-slate-100">
            ...
            <p className="text-xs text-slate-400 mt-1">hours accrued</p>
          </div>
          <div className="bg-white rounded-xl p-5 shadow-sm border border-slate-100">
        ...
        <div className="bg-white rounded-xl p-5 shadow-sm border border-slate-100 mb-6">
          <div className="flex flex-wrap gap-6 text-sm">
            ...
            <div>
              ...
              <span className="font-semibold text-slate-800">{pto.accrualStopBalance} hrs</span>
            </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden">
        <table className="w-full text-sm">
          <thead className="bg-slate-50 border-b border-slate-100">
            <tr>
              {['From', 'To', 'Hours', 'Reason', 'Status', 'Submitted'].map(h => (
          ...
          <tbody className="divide-y divide-slate-50">
            ...
            {requests?.map((r: any) => (
              <tr key={r.id} className="hover:bg-slate-50">
                ...
                <td className="px-5 py-3 text-slate-700">{(r.hours_requested ?? r.days_requested ?? 0).toFixed(2)}</td>
